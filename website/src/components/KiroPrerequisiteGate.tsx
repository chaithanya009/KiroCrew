 ...
 * and the differing tail carries the weight, and ONE hint below both boxes says
 * what the path is — the hint applies to both commands equally, so it sits
 * where a reader of either box finds it.
 */
