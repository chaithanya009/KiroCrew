...
class _GateMixin(ManagerComponent):
    ...
    def spawn_impl(
        ...
        *,
        ...
        # by the explicit agent or else the inherited template -- else the
        # heaviest known (a first fan-out under a new name is priced
        # conservatively); None until the reaper has published anything.
